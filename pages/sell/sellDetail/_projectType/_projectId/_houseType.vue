<template>
  <div class="sellDetail">
    ...
    <div class="wrap w1200">
      <H2>首页>销售项目>{{projectDetail.project_name}}</H2>
        ...
        <div class="left">
          ...
          <div class="xinxi" v-if="type==1">
            ...
            <ul>
              ...
              <li v-if="projectDetail.populations"><span>周边人口：</span><b>{{projectDetail.populations}}/3公里 50000/5公里</b></li>
          ...
          <div class="tuijian">
            ...
            <ul>
              <li v-for="(item,index) in projectRecommended" v-if="index<4" @click="tuijianFun(item)">
                ...
                <p style="margin-top: 10px;"><b></b>{{item.project_name}}</p>
                <div>销售均价：<span>{{item.price}}元/㎡</span></div>
              </li>
            </ul>
          </div>
        </div>
